                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <select name="status_lulus" id="status_lulus" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    <option value="tidak lulus" {{ old('status_lulus') == 'tidak lulus' ? 'selected' : '' }}>Tidak Lulus</option>
                                    <option value="lulus" {{ old('status_lulus') == 'lulus' ? 'selected' : '' }}>Lulus</option>
                                    <option value="lulus bersyarat" {{ old('status_lulus') == 'lulus bersyarat' ? 'selected' : '' }}>Lulus Bersyarat</option>
                                </select>
