                    ...
                    <form action="{{ route('students.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="program_keahlian" id="program_keahlian" value="{{ old('program_keahlian') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div>
                                ...
                                <input type="text" name="konsentrasi_keahlian" id="konsentrasi_keahlian" value="{{ old('konsentrasi_keahlian') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
