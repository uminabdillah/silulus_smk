                        ...
                        <table class="min-w-full divide-y divide-gray-100">
                            <thead>
                                <tr class="bg-gray-50/80">
                                    ...
                                    <th class="px-6 py-4 text-left text-xs font-bold text-gray-400 uppercase tracking-widest">Kelas</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-50">
                                @forelse ($students as $key => $student)
                                    <tr class="group hover:bg-blue-50/30 transition-colors" :class="selectedIds.includes('{{ $student->id }}') ? 'bg-blue-50 shadow-inner' : ''">
                                        ...
                                        <td class="px-6 py-4 text-sm font-bold text-blue-600 border-none">{{ $student->kelas ?? '-' }}</td>
